...
Micro:bit kann ja Zahlen darstellen - es kann diese Zahl so mit dem Zufallsgenerator ermitteln.  Mit Zufallszahl 0 oder 1 kann man Kopf (0) oder Zahl (1) darstellen.
```blocks
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA4ODE5ODc2NywxNTU4ODkyMTcyLC0xMT
